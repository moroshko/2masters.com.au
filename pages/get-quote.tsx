...
const requiredServicesOptions: SelectOption<Service>[] = [
  ...
  { value: "Heating - Service", label: "Heating - Service" },
  { value: "Heating - Repair", label: "Heating - Repair" },
  { value: "Cooling - Supply", label: "Cooling - Supply" },
  { value: "Cooling - Installation", label: "Cooling - Installation" },
  { value: "Cooling - Service", label: "Cooling - Service" },
        ...
        <div>
          ...
          >
            ...
            <div className="field">
              ...
              />
              <div id="mobile-number-error" className="field-error">
            ...
            <div className="field">
              ...
              <input
                ...
                disabled={mutation.isSuccess}
                {...register("suburb", { validate: validateRequired })}
              />
              <div id="suburb-error" className="field-error">
